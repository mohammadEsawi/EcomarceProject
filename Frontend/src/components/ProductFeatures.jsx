    ...
    <section className="bg-white rounded-2xl shadow-lg p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {features.map((feature, index) => (
          <div
            key={index}
            className="flex items-start p-6 hover:bg-secondary hover:text-white rounded-xl transition-transform transform hover:scale-105"
          >
            <div className="bg-gray-100 hover:bg-white p-3 rounded-lg mr-4 text-gray-700">
              {feature.icon}
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-1 group-hover:text-white">
                {feature.title}
              </h3>
